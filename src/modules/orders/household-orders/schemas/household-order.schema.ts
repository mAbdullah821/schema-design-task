...
export type HouseholdOrderDocument = HydratedDocument<HouseholdOrder>;
export const HouseholdOrderSchema =
  SchemaFactory.createForClass(HouseholdOrder);
